#ifndef QOdobrenieKOREKCIJA_H
#define QOdobrenieKOREKCIJA_H

#include "qmybaseformwidget.h"
#include "ui_qOdobreniekorekcija.h"
#include <QStandardItemModel>
#include <QHeaderView>
#include "qstablewidgetdelegate.h"


class QOdobrenieKorekcija : public QMyBaseFormWidget
{
	Q_OBJECT

public:
	QOdobrenieKorekcija(QWidget *parent = 0);
	~QOdobrenieKorekcija();
...
private:
	Ui::QOdobrenieKorekcijaClass ui;
