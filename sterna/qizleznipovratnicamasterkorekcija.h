#ifndef QIZLEZNIpovratnicamasterKOREKCIJA_H
#define QIZLEZNIpovratnicamasterKOREKCIJA_H

#include "qmybaseformwidget.h"
#include "ui_qizleznipovratnicamasterkorekcija.h"
#include <QStandardItemModel>
#include <QHeaderView>
#include "qstablewidgetdelegate.h"


class QIzleznipovratnicamasterKorekcija : public QMyBaseFormWidget
{
	Q_OBJECT

public:
	QIzleznipovratnicamasterKorekcija(QWidget *parent = 0);
	~QIzleznipovratnicamasterKorekcija();
...
private:
	Ui::QIzleznipovratnicamasterKorekcijaClass ui;
...
signals:
	...
	void scallpovratnicamaster(QWidget*, QString);
...
#endif // QIZLEZNIpovratnicamasterKOREKCIJA_H
