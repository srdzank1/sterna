#ifndef QIZLEZNISmetkiVNES_H
#define QIZLEZNISmetkiVNES_H

#include "qmybaseformwidget.h"
#include "ui_qizleznismetkiivnes.h"
#include <QStandardItemModel>
#include <QHeaderView>
#include "qstablewidgetdelegate.h"


class QIzlezniSmetkiVnes : public QMyBaseFormWidget
{
	Q_OBJECT
private:
    Ui::QIzlezniSmetkiVnesClass ui;

public:
	QIzlezniSmetkiVnes(QWidget *parent = 0);
	~QIzlezniSmetkiVnes();
