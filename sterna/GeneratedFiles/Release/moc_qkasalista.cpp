...
static const uint qt_meta_data_QKasaLista[] = {
...
static const char qt_meta_stringdata_QKasaLista[] = {
    "QKasaLista\0\0closeW()\0procF2()\0procF3()\0"
...
void QKasaLista::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        QKasaLista *_t = static_cast<QKasaLista *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QKasaLista::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QKasaLista::staticMetaObject = {
    { &QMyBaseFormWidget::staticMetaObject, qt_meta_stringdata_QKasaLista,
      qt_meta_data_QKasaLista, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QKasaLista::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QKasaLista))
        return static_cast<void*>(const_cast< QKasaLista*>(this));
...
// SIGNAL 3
void QKasaLista::sFakturiToIzvod(QString & _t1, QString & _t2, QString & _t3, QString & _t4)
{
