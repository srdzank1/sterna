...
static const uint qt_meta_data_QPriem[] = {
...
static const char qt_meta_stringdata_QPriem[] = {
    "QPriem\0\0signCloseMyWidget()\0"
    "eCloseKomintentiFromPriemnica()\0,\0"
    "eupdateNanigator(QWidget*,QWidget*)\0"
    "closeWLista()\0text,textName,textNameSaldo\0"
    "callretPriemToDokument(QString&,QString&,QString&)\0"
};
...
void QPriem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        QPriem *_t = static_cast<QPriem *>(_o);
        switch (_id) {
        ...
        case 4: _t->callretPriemToDokument((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData QPriem::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QPriem::staticMetaObject = {
    { &QMyBaseWidget::staticMetaObject, qt_meta_stringdata_QPriem,
      qt_meta_data_QPriem, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QPriem::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPriem))
        return static_cast<void*>(const_cast< QPriem*>(this));
