...
static const uint qt_meta_data_QFinAnalitKomintentiWidget[] = {
...
static const char qt_meta_stringdata_QFinAnalitKomintentiWidget[] = {
    "QFinAnalitKomintentiWidget\0\0closeW()\0"
    "text,textName,textNameSaldo\0"
    "sFinAnalitKomintentiToDokument(QString&,QString&,QString&)\0"
...
void QFinAnalitKomintentiWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        QFinAnalitKomintentiWidget *_t = static_cast<QFinAnalitKomintentiWidget *>(_o);
        switch (_id) {
        case 0: _t->closeW(); break;
        case 1: _t->sFinAnalitKomintentiToDokument((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
...
const QMetaObjectExtraData QFinAnalitKomintentiWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QFinAnalitKomintentiWidget::staticMetaObject = {
    { &QMyBaseFormWidget::staticMetaObject, qt_meta_stringdata_QFinAnalitKomintentiWidget,
      qt_meta_data_QFinAnalitKomintentiWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QFinAnalitKomintentiWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QFinAnalitKomintentiWidget))
        return static_cast<void*>(const_cast< QFinAnalitKomintentiWidget*>(this));
