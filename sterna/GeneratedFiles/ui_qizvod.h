...
public:
    ...
    void setupUi(QMyBaseWidget *QMyIzvodClass)
    {
        if (QMyIzvodClass->objectName().isEmpty())
            QMyIzvodClass->setObjectName(QString::fromUtf8("QMyIzvodClass"));
    ...
    {
        QMyIzvodClass->setWindowTitle(QApplication::translate("QMyIzvodClass", "QMyIzvod", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
