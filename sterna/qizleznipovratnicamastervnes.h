#ifndef QIZLEZNIpovratnicamasterVNES_H
#define QIZLEZNIpovratnicamasterVNES_H

#include "qmybaseformwidget.h"
#include "ui_qizleznipovratnicamastervnes.h"
#include <QStandardItemModel>
#include <QHeaderView>
#include "qstablewidgetdelegate.h"


class QIzleznipovratnicamasterVnes : public QMyBaseFormWidget
{
	Q_OBJECT
private:
    Ui::QIzleznipovratnicamasterVnesClass ui;

public:
	QIzleznipovratnicamasterVnes(QWidget *parent = 0);
...
#endif // QIZLEZNIpovratnicamasterVNES_H
