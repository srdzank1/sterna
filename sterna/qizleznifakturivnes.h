#ifndef QIZLEZNIFAKTURIVNES_H
#define QIZLEZNIFAKTURIVNES_H

#include "qmybaseformwidget.h"
#include "ui_qizleznifakturivnes.h"
#include <QStandardItemModel>
#include <QHeaderView>
#include "qstablewidgetdelegate.h"


class QIzlezniFakturiVnes : public QMyBaseFormWidget
{
	Q_OBJECT
private:
    Ui::QIzlezniFakturiVnesClass ui;

public:
	QIzlezniFakturiVnes(QWidget *parent = 0);
	~QIzlezniFakturiVnes();
